...
- [ ] Explain what a token is used for.
      Allowing users to gain access to your site/backend information with a specific key(token) that allows the app or api or backend to know that they have permissions (headers) to use the site.....

- [ ] What steps can you take in your web apps to keep your data secure?
      Authorization and requiring headers that can only be accessed through tokens. Only then allowing you to push to a Private Route.

- [ ] Describe how web servers work.
      They transfer information and route information around and then return it.
